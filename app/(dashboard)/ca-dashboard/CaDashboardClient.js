        ...
        <div className="dash-kpi-grid" style={{ gridTemplateColumns: 'repeat(6, 1fr)', marginBottom: '1.5rem' }} id="caKpiGrid">
          <div className="dash-kpi">
            <div className="dash-kpi-icon gradient-blue">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 3h12" /><path d="M6 8h12" /><path d="M6 13h8.5a4.5 4.5 0 0 0 0-9H6" /><path d="M6 13h3l9 9" /></svg>
            </div>
